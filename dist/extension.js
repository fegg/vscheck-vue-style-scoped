...
function activate(context) {
    ...
    vscode.workspace.onDidChangeTextDocument((e) => {
        var _a;
        const langId = (_a = vscode.window.activeTextEditor) === null || _a === void 0 ? void 0 : _a.document.languageId;
        const bar = null;
        if (langId === 'vue' && !pass()) {
...
function pass() {
    ...
    const style = text === null || text === void 0 ? void 0 : text.match(/<style[^>]*>/ig);
    if (style) {
